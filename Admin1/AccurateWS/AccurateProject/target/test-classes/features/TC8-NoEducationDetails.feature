...
Feature: TC8- Verify that user able to  select None   on education details/ employee details

  Background:
    Given browser is "chrome"
    And user navigates to the Accurate portal

  @noEduDetails @kioskall
  Scenario: TC8- Verify that user able to  select None   on education details/ employee details
