...
Feature: TC11- Verify that user able to download documents

  Background:
    Given browser is "chrome"
    And user navigates to the Accurate portal

  @downloadDocs @kioskall
  Scenario: TC11- Verify that user able to download documents
    ...
    Then user verify "Done" popup and download documents
