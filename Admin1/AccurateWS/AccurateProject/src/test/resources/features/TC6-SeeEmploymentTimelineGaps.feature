...
Feature: TC6- Verify  that user able to see gaps on Employment Timeline

  Background:
    Given browser is "chrome"
    And user navigates to the Accurate portal

  @empTimelineGaps @kioskall
  Scenario: TC6- Verify  that user able to see gaps on Timeline
